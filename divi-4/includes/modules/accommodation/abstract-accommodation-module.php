...
abstract class MPHB_Divi_Abstract_Accommodation_Module extends ET_Builder_Module {
	...
	abstract public static function get_html( $attrs );
	...
	protected static function get_accommodations_attributes_to_select() {
		...
		foreach ( $mphbAttributes as $custom_attribute ) {
			$attributes_select[ $custom_attribute['attributeName'] ] = $custom_attribute['title'];
		}
