...
const AccommodationAttributesSettingsContent = ( { groupConfiguration } ) => {
	...
	const groups = useMemo( () => {
		...
		applyAccommodationAttributeField( {
			groups: nextGroups,
			fieldName: 'shortcodeAdvancedSelected_attributes',
			mode: 'multiple',
...
export default {
	...
	conversionOutline,
	settings: {
		content: AccommodationAttributesSettingsContent,
	},
